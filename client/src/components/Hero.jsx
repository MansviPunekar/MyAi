  ...
  return (
    ...
    bg-cover bg-no-repeat min-h-screen'>
      ...
      <div className='text-center mb-6'>
           ...
           <p className='mt-4 max-W-xs sm:max-W-lg 2xl:max-W-xl m-automax-sm:text-xs text-gray-600'>transform your content creation wth our suite of premium AI tools.
            Write articles,generate images, and enhance  your workflow.
           </p>
      </div>

      <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
        <button onClick={()=> navigate('/ai')} className='bg-primary text-white px-10 py-3 rounded-lg hover:scale-102 active:scale-95 transition 
      ...
      <div className='flex items-center gap-4 mt-8 mx-auto text-gray-600'>
        <img src={assets.user_group} alt=""  className='h-8' />Trusted by my Classmates 
      </div>
    </div>
  )
}
